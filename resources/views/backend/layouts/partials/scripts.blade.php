...
<script src="{{ asset('admin_assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
<!-- bootstrap 4 js -->
...
<script src="{{ asset('admin_assets/js/line-chart.js') }}"></script>
<!-- all pie chart -->
<script src="{{ asset('admin_assets/js/pie-chart.js') }}"></script>
<!-- all bar chart -->
<script src="{{ asset('admin_assets/js/bar-chart.js') }}"></script>
<!-- all map chart -->
<script src="{{ asset('admin_assets/js/maps.js') }}"></script>
<!-- others plugins -->
