            ...
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left">
                        ...
                        <li><a href="{{ route('admin.roles.index') }}"><span>All Roles</span></a></li>
                        ...
                        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="checkPermissionAll" value="1" {{ App\Models\User::roleHasPermissions($role, $all_permissions) ? 'checked' : '' }} {{ App\Models\User::roleHasPermissions($role, $all_permissions) ? 'checked' : '' }}>
